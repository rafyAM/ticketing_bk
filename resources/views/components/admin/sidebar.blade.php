<div class="drawer-side is-drawer-close:overflow-visible ">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 w-64 is-drawer-close:w-14 is-drawer-open:w-80">
        ...
        <ul class="menu w-full grow gap-1">
            ...
            <!-- Kategori item -->
            <li class="{{ request()->routeIs('admin.categories.index') ? 'bg-gray-200 rounded-lg' : '' }}">
            ...
            <!-- Event item -->
            <li class="{{ request()->routeIs('admin.events.index') ? 'bg-gray-200 rounded-lg' : '' }}">
            ...
            <!-- metode pembayaran  -->
            <li class="{{ request()->routeIs('admin.payments.index') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.payments.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="payments">
            ...
            <!-- History item -->
            <li class="{{ request()->routeIs('admin.histories.index') ? 'bg-gray-200 rounded-lg' : '' }}">
