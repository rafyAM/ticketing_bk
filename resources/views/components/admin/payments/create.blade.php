<x-layouts.admin title="Tambah Event Baru">
    ...
    <div class="container mx-auto p-10">
        <div class="card bg-base-100 shadow-sm">
            <div class="card-body">
                <h2 class="card-title text-2xl mb-6">Tambah Metode Pembayaran Baru</h2>

                <form id="paymentForm" class="space-y-4" method="post" action="{{ route('admin.payments.store') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Nama Event -->
                    ...
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text font-semibold">Nama Pembayaran</span>
                        </label>
                        <input
                            type="text"
                            name="metode_pembayaran"
                            placeholder="Contoh: Metode Pembayaran X"
                            class="input input-bordered w-full"
                            required />
                    </div>
